...
def Inv_Dyn2(theta, theta_d, theta_dd, f_external=None):
    ...
    alp = np.zeros(6)
    th[0] = theta[0]
    th[1] = theta[1]+173.01/180*np.pi
    th[2] = theta[2]-157.51/180*np.pi
    th[3] = theta[3]-15.5/180*np.pi
    ...
    Rt = [Ri.T for Ri in R]
    p = [
    np.array([0.0, 0.0, 0.1367]),
    np.array([0.0, 0.0, 0.0]),
    np.array([0.3846, 0.0, 0.0]),
    np.array([0.3179, 0.0, 0.0]),
    np.array([0.0715, 0.0, 0.0]),
