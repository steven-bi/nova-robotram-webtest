...
def Inv_Dyn(theta, theta_d, theta_dd, f_external=None):
    """6自由度机械臂 Newton–Euler 逆动力学"""
    ...
    th[0] = theta[0]
    th[1] = theta[1]+np.pi
    th[2] = theta[2]-161.26/180*np.pi
    th[3] = theta[3]-18.74/180*np.pi
    ...
    np.array([0.37343, 0.0, 0.0]),
    np.array([0.3049, 0.0, 0.0]),
