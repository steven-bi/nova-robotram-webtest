...
class MotorControl:
    ...
    def __init__(self,can=0) -> None:
        ...
        self.motors_map={}
        CanDLLName = '/home/jetson/Desktop/robotarm_ws/src/pkg_robotarm_py/pkg_robotarm_py/libcontrolcan.so' #把DLL放到对应的目录下
        self.canDLL = cdll.LoadLibrary(CanDLLName)
        self.VCI_USBCAN2 = 4
        self.STATUS_OK = 1
        self.can=can
...
if __name__ == "__main__":
    ...
    for i in range(500):
        ...
        comm.Enable(5)
        comm.Enable(6)
        print(f"{Motor1.state_q},{Motor2.state_q},{Motor3.state_q},{Motor4.state_q},{Motor5.state_q},{Motor6.state_q}")
        time.sleep(0.01)
    # print(time.time()-s)
    ...
    #     )
    #     t_list.append(t)
    #     angle_list.append(Motor3.state_q)
    #     target_list.append(q_des)
    #     vel_list.append(Motor3.state_dq)
